...
<?php
  ...
  if(mysqli_connect_errno()) {
    ...
    if(isset($_POST['delete'])) {
      $sport = $_POST['name'];
      $deleteSport = "delete from sports where sport='$sport'";
      mysqli_query($con, $deleteSport);
      echo "<script>alert('Sport succesfully deleted!');</script>";
    }
?>
<html lang="en">
  <head>
          ...
          <div class="row">
            <div class="animated fadeIn">
              <div class="jumbotron jumbotron-fluid">
                <div class="container">
                  <h1 class="display-3">Look at them sports.</h1>
                  <p class="lead">Here you can view the sports you added for Sportsfest. You can also edit or delete said sports.</p>
                </div>
              </div>
              <div class="col-lg-18">
                <table class="table table-responsive-sm">
                  ...
                  <?php
                    $getSportData = "select * from sports";
                    $sportData = mysqli_query($con, $getSportData);
                    while($data = mysqli_fetch_array($sportData)) {
                      ...
                      echo "<td>";
                    ?>
                    <form method='POST' action='admin-addsport.php' style="display: inline">
                      <input type="hidden" value="<?php echo $data['sport']; ?>" name="sport"/>
                    ...
                    <form method='POST' action='<?php $_PHP_SELF; ?>' style="display: inline" >
                      <input type="hidden" value="<?php echo $data['sport']; ?>" name="name"/>
